class Funcionario {
    ...
    private double planoSaude; // Cobertura
    private double planoOdontologico; // Cobertura
    private double bonificacaoLucros;
    private double impostoRenda;
    private double salarioLiquido;

    public Funcionario(String nomeCompleto, String id, int idade, String genero, String cargo, double salarioBase) {
    ...
    private double calcularValeTransporte() {
        ...
        // Aqui estamos considerando o custo para a empresa, ou seja, o valor que a empresa "paga" ao funcionário
        // Se o funcionário paga uma parte, essa lógica precisa ser mais detalhada.
        // Para este exercício, vamos considerar que o VT é um custo da empresa e entra no custo total de pessoal.
    ...
    public void calcularImpostoRenda() {
        ...
        if (this.impostoRenda < 0) this.impostoRenda = 0; // Imposto não pode ser negativo
    }

    // Método para calcular o salário líquido
    public void calcularSalarioLiquido() {
        // Salário líquido = Salário Base + Bonificação - Imposto de Renda - Vale Transporte (se for um desconto)
        // Para este exercício, vamos considerar VT como um custo da empresa, não um desconto do salário base para o cálculo do líquido
        // Se o VT fosse um desconto, seria: salarioBase + bonificacaoLucros - impostoRenda - valeTransporte;
    ...
    public double getValeRefeicao() { return valeRefeicao; }
    ...
    public double getBonificacaoLucros() { return bonificacaoLucros; }
    ...
    public double getImpostoRenda() { return impostoRenda; }
